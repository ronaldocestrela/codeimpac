        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GitHubUsername = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepositoryFullName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    CommitSha = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Message = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    AuthorName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    AuthorEmail = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewerLogin = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    AuthorLogin = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    IsApproved = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtGitHub = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ClosedAtGitHub = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MergedAtGitHub = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Url = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                name: "GitHubRepositorySelections",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GitHubRepositorySelections", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GitHubAccounts_GitHubUserId",
                table: "GitHubAccounts",
                column: "GitHubUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GitHubCommits_UserId_RepositoryId_CommitSha",
                table: "GitHubCommits",
                columns: new[] { "UserId", "RepositoryId", "CommitSha" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GitHubPullRequestReviews_GitHubReviewId",
                table: "GitHubPullRequestReviews",
                column: "GitHubReviewId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GitHubPullRequests_UserId_RepositoryId_GitHubPullRequestId",
                table: "GitHubPullRequests",
                columns: new[] { "UserId", "RepositoryId", "GitHubPullRequestId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GitHubRepositorySelections_UserId_RepositoryId",
